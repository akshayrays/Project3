...
<a href="/project_3/ctl/JasperCtl" class="btn btn-lg btn-warning " role="button" target="blank">
<span class="fa fa-print mr-1"></span>Print</a>
			...
			<div style="margin-bottom: 20px;" class="table-responsive">
				...
				<div style="padding-left: 48%;">
					<input type="submit" name="operation" class="btn btn-dark btn-md" style="font-size: 17px"
