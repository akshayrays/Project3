		...
		<form action="<%=ORSView.USER_CTL%>" method="post">
			...
			<div class="row pt-3">
				...
				<div class="col-md-4 mb-4">
						...
						<div class="card-body">
							...
							<div class="md-form">
								...
								if (dto.getId()!=null && dto.getId()>0) {
							        ...
							        <div>
							        <input type="hidden" class="form-control" name="password" placeholder="Password" value="<%=DataUtility.getStringData(dto.getPassword())%>">
							</div>
														<div>
					...
					<%	} else{ %> <span class="pl-sm-5"><b>Password</b> <span
							style="color: red;">*</span></span> </br>
						<div class="col-sm-12">
							<div class="input-group">
								<div class="input-group-prepend">
